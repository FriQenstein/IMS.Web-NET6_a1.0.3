...
namespace IMS.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                //StartDate = DateTime.Now,   this allows the form to default to the current date
                LeaveTypes = new SelectList(_context.LeaveTypes, "Id", "Name")
            };
            //ViewData["LeaveTypeId"] = new SelectList(_context.LeaveTypes, "Id", "Name");   // create a SelectList with values from LeaveTypes table but show the NAME instead of ID
            return View(model);
        }
